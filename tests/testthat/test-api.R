httptest2::with_mock_dir("basic_request", {
...
httptest2::with_mock_dir("path_params", {
...
testthat::test_that("usasp handles query parameters correctly", {
  httptest2::with_mock_dir("query_params", {
...
httptest2::with_mock_dir("pagination", {
...
httptest2::with_mock_dir("errors", {
