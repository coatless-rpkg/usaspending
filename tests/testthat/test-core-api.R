httptest2::with_mock_dir("core/basic_request", {
...
httptest2::with_mock_dir("core/path_params", {
...
testthat::test_that("usasp handles query parameters correctly", {
  httptest2::with_mock_dir("core/params", {
...
httptest2::with_mock_dir("core/page", {
...
httptest2::with_mock_dir("core/errors", {
